      ...
      <ScrollAnimation animateIn="flipInX">
        <div className="project">
          ...
          <div className="project-links">
            <a href="https://gabrielbundea.imgbb.com/albums" target="_blank" rel="noreferrer">
              <img src={externalLinkIcon} alt="GitHub" />
            </a>
          </div>
          </header>
          <div className="body">
            <h3>Graphic Designs</h3>
            <p>Here are all my projects within the<a href="https://agropro.ro/"> company</a> I work in for 2 years, from banners, product designs, product labels, box designs.
            </p>
          </div>
          <footer>
